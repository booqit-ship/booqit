            ...
            <CardContent className="p-6" onClick={() => onRoleSelect('customer')}>
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-poppins font-normal">I'm a Customer</h3>
          ...
          <Card className="cursor-pointer hover:shadow-lg transition-all duration-200 border-2 hover:border-booqit-primary/50">
            <CardContent className="p-6" onClick={() => onRoleSelect('merchant')}>
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-lg font-righteous font-medium">I'm a Business Owner</h3>
                  <p className="text-gray-600 text-sm font-poppins">Manage my salon or spa business</p>
                </div>
              </div>
            </CardContent>
          </Card>
