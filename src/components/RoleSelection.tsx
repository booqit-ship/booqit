  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-lavender-50 to-purple-50 flex flex-col">
      ...
      <motion.div 
        ...
        className="w-full px-4 pt-8 pb-4"
      >
        <div className="w-full max-w-sm mx-auto">
          <img 
            src="/lovable-uploads/ba3c5831-50e8-4a39-85d7-ad6ec4c98d6a.png"
            alt="BooqIt - Beauty Booking"
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8">
        ...
        >
          ...
          >
            <h1 className="text-4xl font-righteous font-bold text-gray-900 mb-3">
              booqit
            </h1>
