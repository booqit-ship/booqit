    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-white px-6 py-8">
      ...
      >
        <motion.button
          ...
          className="w-full bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-red-300"
        >
        ...
        <motion.button
          ...
          className="w-full bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-orange-300"
        >
          <div className="flex items-center">
