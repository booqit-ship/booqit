                ...
                >
                  <div className="relative">
                    ...
                    <div className="w-full h-48 relative">
                      ...
                      {/* Rating Badge */}
                      {merchant.rating && (
                        <div className="absolute top-3 right-3 bg-white/95 backdrop-blur-sm rounded-full px-2 py-1 flex items-center shadow-md">
                              ...
                              <div className="flex items-center">
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <Star
                                    ...
                                    className={cn(
                                      "w-3 h-3",
                                      star <= Math.floor(merchant.rating || 0)
                                        ? "text-yellow-500 fill-yellow-500"
                                        : star - 0.5 <= (merchant.rating || 0)
                                        ? "text-yellow-500 fill-yellow-500"
                                        : "text-gray-300"
                                    )}
                                  />
