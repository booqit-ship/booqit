        ...
        <div className="flex items-center justify-between w-full px-4 mb-3">
          <div className="flex gap-3 items-center w-full">
            ...
            <Select value={filters.category} onValueChange={(value) => handleFilterChange('category', value)}>
              <SelectTrigger 
                className="flex-1 h-9 rounded-full text-sm border-gray-300 font-poppins" 
        ...
        <div className="px-4 py-4 border-t border-gray-100 bg-gray-50 flex-shrink-0">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button 
              ...
              className="text-booqit-primary font-poppins"
            >
              Reset
            </Button>
          </div>
                ...
                >
                  <div className="relative">
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="mb-3">
                        <h3 className="font-bold text-lg text-gray-900 mb-1 font-righteous font-medium">
                          {merchant.shop_name}
                        </h3>
                          ...
                          {merchant.services.slice(0, 3).map((service, index) => (
                            <div key={service.id} className="flex justify-between items-center">
                              <div className="flex-1">
                                <h4 className="font-medium text-gray-900 text-sm font-poppins">{service.name}</h4>
