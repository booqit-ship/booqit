...
const BookingCard: React.FC<BookingCardProps> = ({
  ...
  return <Card className={`hover:shadow-lg transition-shadow duration-200 border-l-4 ${booking.status === 'completed' ? 'border-l-blue-500 bg-blue-50/30' : 'border-l-booqit-primary'}`}>
      <CardContent className="p-4">
        ...
        {booking.service && <div className="space-y-2 mb-3">
            <div className="flex items-center space-x-2">
            ...
            {booking.service.duration && <div className="flex items-center space-x-2 text-gray-600">
        ...
        <div className="space-y-2 mb-4">
          {booking.customer_name && <div className="flex items-center space-x-2 text-gray-700">
          ...
          {booking.customer_phone && <div className="flex items-center space-x-2 text-gray-600">
              ...
              <a href={`tel:${booking.customer_phone}`} className="text-booqit-primary hover:underline cursor-pointer">
                {booking.customer_phone}
              </a>
            </div>}
          
          {booking.stylist_name && <div className="flex items-center space-x-2 text-gray-700">
