  ...
  return <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-gray-50/30">
      ...
      <CardContent className="p-6">
        {isLoading ? <div className="flex justify-center py-12">
          ...
          </div> : visibleBookings.length === 0 ? <div className="text-center py-12 bg-gray-50 rounded-xl border border-gray-200">
            ...
            {visibleBookings.map(booking => <BookingCard key={booking.id} booking={booking} onStatusChange={onStatusChange} />)}
          </div>}
      </CardContent>
    </Card>;
};
