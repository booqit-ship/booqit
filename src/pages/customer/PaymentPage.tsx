...
import BookingSuccessAnimation from '@/components/animations/BookingSuccessAnimation';
import BookingFailedAnimation from '@/components/animations/BookingFailedAnimation';
...
const PaymentPage: React.FC = () => {
  ...
  const handleSuccessComplete = () => {
    ...
    const bookingId = 'temp-booking-id'; // This should be the actual booking ID from the response
  ...
  const handleRetry = () => {
    setShowFailedAnimation(false);
    setIsProcessing(false);
    // Reset to allow user to try payment again
  };
  ...
  return (
    <>
      ...
      {showSuccessAnimation && (
        <BookingSuccessAnimation onComplete={handleSuccessComplete} />
      )}

      {/* Failed Animation */}
      {showFailedAnimation && (
        <BookingFailedAnimation 
          onComplete={handleFailedComplete}
          onRetry={handleRetry}
        />
      )}
