                ...
                <div className="flex flex-col items-center">
                  <div className="relative mb-4">
                    <Avatar className="h-24 w-24 cursor-pointer border-2 border-booqit-primary" onClick={handleAvatarClick}>
                      {avatarUrl ? <AvatarImage src={avatarUrl} alt={user?.name || 'User'} /> : <AvatarFallback className="bg-booqit-primary/20 text-booqit-primary">
            ...
            <Tabs defaultValue="account" className="w-full">
                ...
                <Card>
                  ...
                  <CardContent>
                    <form onSubmit={handleUpdateProfile} className="space-y-6">
                      ...
                      <Button type="submit" className="bg-booqit-primary" disabled={isSaving}>
              ...
              <TabsContent value="history">
                <Card>
                  ...
                  <CardContent>
                    {bookings.length === 0 ? <div className="py-6 px-4 text-center border rounded-md">
                        ...
                        {bookings.map(booking => <Card key={booking.id} className="overflow-hidden">
                            <div className={`p-3 ${booking.status === 'completed' ? 'bg-green-50' : booking.status === 'cancelled' ? 'bg-red-50' : 'bg-blue-50'}`}>
                              <div className="flex justify-between items-center">
                                ...
                                <div className="text-right">
                                  <span className={`text-xs px-2 py-1 rounded-full ${booking.status === 'completed' ? 'bg-green-100 text-green-800' : booking.status === 'cancelled' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'}`}>
              ...
              <TabsContent value="reviews">
                <Card>
                  ...
                  <CardContent>
                    {reviews.length === 0 ? <div className="py-6 px-4 text-center border rounded-md">
                        ...
                        {reviews.map(review => <Card key={review.id}>
                            <div className="p-4">
                              ...
                              {review.review && <div className="bg-muted/20 p-3 rounded-md">
