...
const SettingsPage: React.FC = () => {
  ...
  return <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4 space-y-6 pb-24">
        ...
        {/* Booking URL Manager */}
        {merchant && <div className="space-y-1">
            <h2 className="text-lg px-1 mb-3 font-thin">Share Your Business</h2>
            <BookingUrlManager merchantId={merchant.id} shopName={merchant.shop_name} />
          </div>}

        {/* Business Management */}
        <div className="space-y-1">
          <h2 className="text-lg px-1 mb-3 font-medium">Business Management</h2>
          {settingsItems.slice(0, 3).map(item => <Link key={item.href} to={item.href}>
        ...
        {/* General Settings */}
        <div className="space-y-1">
          <h2 className="text-lg px-1 mb-3 font-medium">General Settings</h2>
          {settingsItems.slice(3).map(item => <Link key={item.href} to={item.href}>
              <Card className="hover:bg-gray-50 transition-colors">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
        ...
        {/* Danger Zone */}
        <div className="space-y-1">
          <h2 className="text-lg px-1 mb-3 text-red-600 font-medium">Danger Zone</h2>
