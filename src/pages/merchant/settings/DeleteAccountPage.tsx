...
const DeleteAccountPage: React.FC = () => {
  ...
  const handleSendDeletionRequest = () => {
    ...
    const subject = encodeURIComponent('Merchant Account Deletion Request - BooqIt');
    const body = encodeURIComponent(`
Dear BooqIt Support Team,

I am requesting the permanent deletion of my BooqIt merchant account and all associated data.
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b sticky top-0 z-10">
        <div className="flex items-center gap-3 p-4">
          ...
          <div>
            <h1 className="text-xl font-semibold text-red-600">Delete Merchant Account</h1>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-700 mb-4">
              If you're having issues with your merchant account or considering deletion due to a problem, 
            ...
            <div className="space-y-2">
              <Button
                ...
                onClick={() => window.open('mailto:support@booqit.in?subject=Merchant Account Support', '_blank')}
              >
                <Mail className="h-4 w-4 mr-2" />
                Contact Support First
              </Button>
              <Link to="/merchant/settings/contact">
