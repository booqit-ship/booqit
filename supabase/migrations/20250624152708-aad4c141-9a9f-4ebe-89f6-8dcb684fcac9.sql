...
DROP POLICY IF EXISTS "Cross user token access for notifications" ON public.device_tokens;
...
-- Ensure the get_notification_tokens function exists and works properly
